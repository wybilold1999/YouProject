 ...
 * 获取个人的所有的视频列表
 */
public class GetVideoListRequest extends ResultPostExecute<List<VideoModel>> {
    public void request(String userId, int pageNo, int pageSize) {
        ArrayMap<String, String> params = new ArrayMap<>();
        params.put("pageNo", String.valueOf(pageNo));
        params.put("pageSize", String.valueOf(pageSize));
        params.put("userId", userId);
        Call<ResponseBody> call = AppManager.getVideoService().getVideoList(AppManager.getClientUser().sessionId, params);
