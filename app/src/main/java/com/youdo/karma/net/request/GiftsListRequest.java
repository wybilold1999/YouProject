 ...
 * 我收到的礼物
 */
public class GiftsListRequest extends ResultPostExecute<List<ReceiveGiftModel>> {
    public void request(final int pageNo, final int pageSize){
        ...
        Call<ResponseBody> call = AppManager.getFollowService().getGiftsList(AppManager.getClientUser().sessionId, params);
    ...
    private void parseJson(String json){
        try {
            ...
            onPostExecute(receiveGiftModels);
        } catch (Exception e) {
//            onErrorExecute(CSApplication.getInstance().getResources()
