 ...
 */
public class GetDiscoverInfoRequest extends ResultPostExecute<List<PictureModel>> {
    public void request(final int pageNo, final int pageSize){
        ArrayMap<String, String> params = new ArrayMap<>();
        params.put("pageNo", String.valueOf(pageNo));
        params.put("pageSize", String.valueOf(pageSize));
        Call<ResponseBody> call = AppManager.getPictureService().getDiscoverPictures(
