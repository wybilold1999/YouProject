...
public class PreferencesUtils {
	...
	/** 聊天次数限制*/
	public static final String SETTINGS_CHAT_LIMIT = "com.youdo.karma_chat_limit";
	/** (我约会的)改变约会状态的userid*/
	public static final String SETTINGS_I_APPOINT_USER_ID = "com.youdo.karma_i_appoint_user_id";
	/** (约我的)改变约会状态的userid*/
	public static final String SETTINGS_APPOINT_ME_USER_ID = "com.youdo.karma_appoint_me_user_id";
	/** 省份*/
	...
	/** 是否有领取话费的活动*/
	public static final String SETTINGS_IS_HAS_GET_FARE_ACTIVITY = "com.youdo.karma_is_has_get_fare_activity";
	/** 购买的是多少钱的vip*/
	public static final String SETTINGS_WHICH_VIP = "com.youdo.karma_which_vip";
	/** 登录的次数*/
